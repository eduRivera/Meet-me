...
user1 = User.create name:'Edu', email:'edu@gmail.com', pwd:'1234'
user2 = User.create name:'Marc', email:'marc@gmail.com', pwd:'1234'
...
Visit.create location_id: location1.id, user_id: user2.id, user_name: user2.name, from_date: Date.today+12, to_date: Date.today+14
Visit.create location_id: location1.id, user_id: user1.id, user_name: user1.name, from_date: Date.today, to_date: Date.today+2
Visit.create location_id: location2.id, user_id: user2.id, user_name: user2.name, from_date: Date.today, to_date: Date.today+5
Visit.create location_id: location3.id, user_id: user1.id, user_name: user1.name, from_date: Date.today, to_date: Date.today+1
Visit.create location_id: location4.id, user_id: user1.id, user_name: user1.name, from_date: Date.today, to_date: Date.today+1
